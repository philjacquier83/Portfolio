                ...
                <div className="containerModal">
                    ...
                    <div className='textModal'>
                        <div className="visual">
                            <div className='arrowNav'><FontAwesomeIcon icon={faAngleLeft} onClick={handlePreviousImg} /></div>
                            <img src={visuals[currentImg].src} />
                            <div className='arrowNav'><FontAwesomeIcon icon={faAngleRight} onClick={handleNextImg} /></div>
                        </div>
